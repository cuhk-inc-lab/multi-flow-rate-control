...
/* Sized for ~1 Gbps opaque forward bursts (VM WiFi path measured hwm ~700). */
#ifndef RELAY_DEFAULT_DEFERRED_PER_FLOW
#define RELAY_DEFAULT_DEFERRED_PER_FLOW 4096u
#endif

#ifndef RELAY_DEFAULT_DEFERRED_TOTAL
#define RELAY_DEFAULT_DEFERRED_TOTAL 32768u
#endif
